...
- **Run python script to generate ONNX model and run the demo**
    ...
    example:
    python demo_darknet2onnx.py ../build/darknet/x64/exp/result_lr.005_batch128_subd16_dsize480_pretrain_s1.8_e1.8_h2_a10_reanchor_random1/cfg_test_backup.cfg ../build/darknet/x64/exp/result_lr.005_batch128_subd16_dsize480_pretrain_s1.8_e1.8_h2_a10_reanchor_random1/cfg_train_backup_best.weights ./data/cane4.jpg 1
    ```
